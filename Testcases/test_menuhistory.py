...
class Test_project:  
    ...
    def test_history(self,startup):
        if(self.driver.current_url == "https://katalon-demo-cura.herokuapp.com/appointment.php#summary"):
           ...
           his = self.driver.find_element(by=By.XPATH, value=location.Location.history)
           action = ActionChains(self.driver)
           action.click(on_element=his).perform()
           print("history shown")
           self.driver.find_element(by=By.XPATH, value="/html/body/section/div/div[3]/p/a").click()
           sleep(3)
